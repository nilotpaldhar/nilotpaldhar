...
- **Frontend:** Next.js, React, TypeScript, Redux, Zustand, Tailwind CSS, Shadcn UI
- **Backend:** Node.js (Express), Prisma, REST APIs
- **Databases:** PostgreSQL, MySQL
- **Dev Tools:** VS Code, Git/GitHub, Figma

---

### 📊 GitHub Stats

![GitHub Streak](https://streak-stats.demolab.com/?user=nilotpaldhar&count_private=true&theme=gruvbox)

---

### 🎯 Philosophy

> _"Code simply. Design for users. Build for the long haul."_
